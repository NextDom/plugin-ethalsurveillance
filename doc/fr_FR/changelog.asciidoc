...
** Ajout de la gestion des commandes mortes sur le plugin (dispo dans la prochaine mise à jour du core)
** correction de bug
** Ajout d'un widget pour afficher le graphique du temps d'activité
** ???

* Version 2.0 (Version market)		
