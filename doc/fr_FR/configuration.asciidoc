...
** *Valeur surveillance inactive* : obligatoire si *Compteur Général* NON coché, valeur analogique en dessous de laquelle l'équipement à surveiller est considéré inactif(voir egalement la description de *Délai valeur surveillance inactive (min)* ci dessous
