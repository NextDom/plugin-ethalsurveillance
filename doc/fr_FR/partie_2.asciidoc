...
== Cas d'utilisation
* Surveiller la durée a laquelle votre télévison est allumé
...
** *Temps min de fonctionnement* : laisser vide
** *Temps max de fonctionnement* : laisser vide

le compteur sera incrementé de 1, la commande *Etat* passera a ON, si la valeur mesure de puissance est superieur à 100W, 
